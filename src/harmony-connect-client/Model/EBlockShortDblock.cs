...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EBlockShortDblock :  IEquatable<EBlockShortDblock>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockShortDblock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EBlockShortDblock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockShortDblock" /> class.
        /// </summary>
        ...
        public EBlockShortDblock(string keymr = default(string), int? height = default(int?), string href = default(string))
        {
            // to ensure "keymr" is required (not null)
            if (keymr == null)
            {
                throw new InvalidDataException("keymr is a required property for EBlockShortDblock and cannot be null");
            }
            else
            {
                this.Keymr = keymr;
            ...
            if (height == null)
            {
                throw new InvalidDataException("height is a required property for EBlockShortDblock and cannot be null");
            }
            else
            {
                this.Height = height;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for EBlockShortDblock and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EBlockShortDblock {\n");
        ...
        {
            return this.Equals(input as EBlockShortDblock);
        }

        /// <summary>
        /// Returns true if EBlockShortDblock instances are equal
        /// </summary>
        /// <param name="input">Instance of EBlockShortDblock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EBlockShortDblock input)
        {
            if (input == null)
                return false;
