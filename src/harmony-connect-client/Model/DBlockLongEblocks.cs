...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DBlockLongEblocks :  IEquatable<DBlockLongEblocks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DBlockLongEblocks" /> class.
        /// </summary>
        ...
        public DBlockLongEblocks(string keymr = default(string), string href = default(string), DBlockLongBtcAnchorEntryChain chain = default(DBlockLongBtcAnchorEntryChain))
        {
            this.Keymr = keymr;
            this.Href = href;
            this.Chain = chain;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DBlockLongEblocks {\n");
        ...
        {
            return this.Equals(input as DBlockLongEblocks);
        }

        /// <summary>
        /// Returns true if DBlockLongEblocks instances are equal
        /// </summary>
        /// <param name="input">Instance of DBlockLongEblocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DBlockLongEblocks input)
        {
            if (input == null)
                return false;
