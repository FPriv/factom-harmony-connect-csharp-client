...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EBlockLong :  IEquatable<EBlockLong>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockLong" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EBlockLong() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockLong" /> class.
        /// </summary>
        /// <param name="keymr">The Key Merkle Root for this entry block. (required).</param>
        /// <param name="sequence">Shows where this entry block falls within the list of entry blocks that are contained in the parent directory block. (required).</param>
        ...
        /// <param name="entries">An API link to all of the entries in this entry block. (required).</param>
        public EBlockLong(string keymr = default(string), int? sequence = default(int?), EBlockLongPrev prev = default(EBlockLongPrev), EBlockLongNext next = default(EBlockLongNext), EBlockShortChain chain = default(EBlockShortChain), EBlockShortDblock dblock = default(EBlockShortDblock), Object startedAt = default(Object), string href = default(string), string entries = default(string))
        {
            // to ensure "keymr" is required (not null)
            if (keymr == null)
            {
                throw new InvalidDataException("keymr is a required property for EBlockLong and cannot be null");
            }
            else
            {
                this.Keymr = keymr;
            ...
            if (sequence == null)
            {
                throw new InvalidDataException("sequence is a required property for EBlockLong and cannot be null");
            }
            else
            {
            ...
            if (chain == null)
            {
                throw new InvalidDataException("chain is a required property for EBlockLong and cannot be null");
            }
            else
            {
                this.Chain = chain;
            ...
            if (dblock == null)
            {
                throw new InvalidDataException("dblock is a required property for EBlockLong and cannot be null");
            }
            else
            {
                this.Dblock = dblock;
            ...
            if (startedAt == null)
            {
                throw new InvalidDataException("startedAt is a required property for EBlockLong and cannot be null");
            }
            else
            {
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for EBlockLong and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (entries == null)
            {
                throw new InvalidDataException("entries is a required property for EBlockLong and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Shows where this entry block falls within the list of entry blocks that are contained in the parent directory block.</value>
        ...
        public EBlockLongPrev Prev { get; set; }

        /// <summary>
        /// Gets or Sets Next
        /// </summary>
        [DataMember(Name="next", EmitDefaultValue=false)]
        public EBlockLongNext Next { get; set; }
        ...
        /// </summary>
        /// <value>An API link to all of the entries in this entry block.</value>
        ...
        {
            return this.Equals(input as EBlockLong);
        }

        /// <summary>
        /// Returns true if EBlockLong instances are equal
        /// </summary>
        /// <param name="input">Instance of EBlockLong to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EBlockLong input)
        {
            if (input == null)
                return false;
