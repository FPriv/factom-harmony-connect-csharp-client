...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EBlockLink :  IEquatable<EBlockLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockLink" /> class.
        /// </summary>
        ...
        public EBlockLink(string keymr = default(string), string href = default(string))
        {
            this.Keymr = keymr;
            this.Href = href;
        }
        ...
        {
            return this.Equals(input as EBlockLink);
        }

        /// <summary>
        /// Returns true if EBlockLink instances are equal
        /// </summary>
        /// <param name="input">Instance of EBlockLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EBlockLink input)
        {
            if (input == null)
                return false;
