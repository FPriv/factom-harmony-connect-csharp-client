...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EntryDataEblock :  IEquatable<EntryDataEblock>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntryDataEblock" /> class.
        /// </summary>
        ...
        public EntryDataEblock(string keymr = default(string), string href = default(string))
        {
            this.Keymr = keymr;
            this.Href = href;
        }
        ...
        {
            return this.Equals(input as EntryDataEblock);
        }

        /// <summary>
        /// Returns true if EntryDataEblock instances are equal
        /// </summary>
        /// <param name="input">Instance of EntryDataEblock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntryDataEblock input)
        {
            if (input == null)
                return false;
