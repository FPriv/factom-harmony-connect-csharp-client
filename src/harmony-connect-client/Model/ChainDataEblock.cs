...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChainDataEblock :  IEquatable<ChainDataEblock>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainDataEblock" /> class.
        /// </summary>
        ...
        public ChainDataEblock(string keymr = default(string), string href = default(string))
        {
            this.Keymr = keymr;
            this.Href = href;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainDataEblock {\n");
        ...
        {
            return this.Equals(input as ChainDataEblock);
        }

        /// <summary>
        /// Returns true if ChainDataEblock instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainDataEblock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainDataEblock input)
        {
            if (input == null)
                return false;
