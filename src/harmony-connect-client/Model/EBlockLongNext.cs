...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EBlockLongNext :  IEquatable<EBlockLongNext>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockLongNext" /> class.
        /// </summary>
        ...
        public EBlockLongNext(string keymr = default(string), string href = default(string))
        {
            this.Keymr = keymr;
            this.Href = href;
        }
        ...
        {
            return this.Equals(input as EBlockLongNext);
        }

        /// <summary>
        /// Returns true if EBlockLongNext instances are equal
        /// </summary>
        /// <param name="input">Instance of EBlockLongNext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EBlockLongNext input)
        {
            if (input == null)
                return false;
