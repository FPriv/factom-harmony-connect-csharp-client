...
namespace harmony-connect-client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EBlockLongPrev :  IEquatable<EBlockLongPrev>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EBlockLongPrev" /> class.
        /// </summary>
        ...
        public EBlockLongPrev(string keymr = default(string), string href = default(string))
        {
            this.Keymr = keymr;
            this.Href = href;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EBlockLongPrev {\n");
        ...
        {
            return this.Equals(input as EBlockLongPrev);
        }

        /// <summary>
        /// Returns true if EBlockLongPrev instances are equal
        /// </summary>
        /// <param name="input">Instance of EBlockLongPrev to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EBlockLongPrev input)
        {
            if (input == null)
                return false;
