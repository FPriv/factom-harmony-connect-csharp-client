...
${nuget_cmd} install src/harmony-connect-client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/harmony-connect-client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/harmony-connect-client.dll \
-recurse:'src/harmony-connect-client/*.cs' \
-doc:bin/harmony-connect-client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/harmony-connect-client.dll was created successfully"
fi
